...
pub fn init_routers<Storage, Searcher>(
    telemetry_config: &TelemetryConfig,
) -> Router<Arc<ServerApp<Storage, Searcher>>>
where
    ...
    Storage: IIndexStorage + IDocumentPartStorage + Send + Sync + 'static,
{
    ...
    let trace_layer =
        trace::TraceLayer::new_for_http().make_span_with(otlp::PathFilter::new(attributes.clone()));
